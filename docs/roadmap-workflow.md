...
`work_item_id`, `claimed_by`, scope и `depends_on`, очищает candidate,
acceptance/design/verdict/history fields и активные audit/reviewer roles, ставит
`review_round: 0`. Orchestrator назначает нового auditor и выполняет
