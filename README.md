...
> **Disclaimer:** этот проект не связан с LaunchBox, не одобрен и не спонсируется его разработчиками. Используйте утилиту на свой риск; перед `--apply` проверяйте dry-run отчёты и резервные копии.
